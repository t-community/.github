...
希望能夠過共享Repo, CICD 和 image 路徑, 解決一直以來透過個人帳號維護開源專案的困擾，包括但不限於：
...
判斷的參考點：如果這段程式碼不是純粹的個人練習，而是「將來有可能被團隊中的其他人需要」，那放在 org 底下會比放在個人帳號更有價值。
...
> 這個 org 是開放給大家共用的空間，有任何想法或問題，歡迎大家直接開 Issue 或在 org 的討論區留言。
